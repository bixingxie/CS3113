...
void ProcessGameInput(SDL_Event* event, bool& done, std::vector<Entity_textured>& bullets, const Entity_textured& player){
...
void UpdateGame(std::vector<Entity_textured>& enemies, Entity_textured& player, std::vector<Entity_textured>& bullets, float elapsed, GameMode& gameMode){
...
int main(int argc, char *argv[])
{
    ...
    while (!done) {
        ...
        if(mode == STATE_MAIN_MENU){
            ...
            UpdateGame(enemies, player, bullets, elapsed, mode);
